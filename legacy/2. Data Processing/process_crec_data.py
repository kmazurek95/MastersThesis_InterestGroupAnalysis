...
def main():
    ...
    """
    data_dir = os.environ.get("DATA_PATH", os.path.join(os.path.dirname(__file__), "..", "..", "data", "Proccessed API Calls"))
    output_dir = os.environ.get("OUTPUT_PATH", os.path.join(os.path.dirname(__file__), "..", "..", "output"))
