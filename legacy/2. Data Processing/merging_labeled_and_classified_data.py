...
def main():
    ...
    json_file_path = os.path.join(DATA_PATH, "Paragraphs", "3B_____PARAGRAPHS_name_AND_acronym_114_AND_115_EXPANDED__UPDATED__4-29-2023____1.json")
    predictions_path = os.path.join(DATA_PATH, "Classifier", "Model", "predictions.json")
