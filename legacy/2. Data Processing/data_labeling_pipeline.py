...
DATA_PATH = os.environ.get("DATA_PATH", os.path.join(os.path.dirname(__file__), "..", "..", "data", "Paragraphs"))
OUTPUT_PATH = os.environ.get("OUTPUT_PATH", os.path.join(os.path.dirname(__file__), "..", "..", "output"))
LABELED_DATA_PATH = os.environ.get("LABELED_DATA_PATH", os.path.join(os.path.dirname(__file__), "..", "..", "data", "Classifier"))
