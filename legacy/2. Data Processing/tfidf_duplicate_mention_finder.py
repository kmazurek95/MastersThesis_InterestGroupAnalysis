...
if __name__ == "__main__":
    ...
    input_file = os.path.join(DATA_PATH, "Mentions", "CREC_115", "Mentions_Name_115", "Data_Input_and_Final_Output", "CREC_115_paragraphs_raw_uuid.json")
    ...
    output_file = os.path.join(OUTPUT_PATH, "similar_paragraphs.csv")
