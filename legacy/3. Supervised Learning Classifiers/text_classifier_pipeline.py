...
if __name__ == "__main__":
    labeled_path = os.environ.get("LABELED_DATA_PATH", os.path.join("data", "Labeled_Data__Version_____1.csv"))
    unlabeled_path = os.environ.get("UNLABELED_DATA_PATH", os.path.join("data", "Un-labeled_data.csv"))
