...
1. Technical Report MA Thesis.pdf
   - A detailed technical report summarizing the research process, methodologies, and key findings of the thesis. This document is a concise resource for understanding the technical underpinnings of the study.

2. Thesis_UvA_Kaleb_Mazurek.pdf
   - The full Master’s thesis providing a thorough exploration of the dynamics influencing advocacy group prominence in democratic legislative processes. It includes:
...
3. Methodological Innovation:
   - Used nearly 78,000 legislative transcripts and employed supervised machine learning (a Multinomial Naive Bayes classifier, F1 ≈ 0.73) to classify mentions of interest groups.
