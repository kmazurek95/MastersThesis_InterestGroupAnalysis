...
rm(model_a1, model_a2, compare_models_a, or_table_a2, pred_a); gc()
```
...
rm(model_b1, model_b2, compare_models_b, pred_b_seniority); gc()
```
...
rm(model_c1, model_c2, compare_models_c, pred_c_lobbyist, empty_model); gc()
```
